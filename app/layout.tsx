...
export const metadata: Metadata = {
  title: "Spin My Roster | NFL Fantasy Team Builder",
  description:
    "Build your dream NFL roster by spinning for random teams and selecting players. A fun slot machine game for football fans.",
  generator: "Fran",
  icons: {
    icon: [
      {
